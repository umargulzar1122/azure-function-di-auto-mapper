...
namespace YourNamespace
{
	...
	public partial class Contact : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<YourNamespace.Account> account_primary_contact
		{
			get
			{
				return this.GetRelatedEntities<YourNamespace.Account>("account_primary_contact", null);
			}
			set
			{
				this.OnPropertyChanging("account_primary_contact");
				this.SetRelatedEntities<YourNamespace.Account>("account_primary_contact", null, value);
		...
		public System.Collections.Generic.IEnumerable<YourNamespace.Contact> Referencedcontact_customer_contacts
		{
			get
			{
				return this.GetRelatedEntities<YourNamespace.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedcontact_customer_contacts");
				this.SetRelatedEntities<YourNamespace.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public System.Collections.Generic.IEnumerable<YourNamespace.Contact> Referencedcontact_master_contact
		{
			get
			{
				return this.GetRelatedEntities<YourNamespace.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedcontact_master_contact");
				this.SetRelatedEntities<YourNamespace.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public YourNamespace.Account contact_customer_accounts
		{
			get
			{
				return this.GetRelatedEntity<YourNamespace.Account>("contact_customer_accounts", null);
			}
			set
			{
				this.OnPropertyChanging("contact_customer_accounts");
				this.SetRelatedEntity<YourNamespace.Account>("contact_customer_accounts", null, value);
		...
		public YourNamespace.Contact Referencingcontact_customer_contacts
		{
			get
			{
				return this.GetRelatedEntity<YourNamespace.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.OnPropertyChanging("Referencingcontact_customer_contacts");
				this.SetRelatedEntity<YourNamespace.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
		...
		public YourNamespace.Contact Referencingcontact_master_contact
		{
			get
			{
				return this.GetRelatedEntity<YourNamespace.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
		}
		...
		public YourNamespace.Account msa_contact_managingpartner
		{
			get
			{
				return this.GetRelatedEntity<YourNamespace.Account>("msa_contact_managingpartner", null);
			}
			set
			{
				this.OnPropertyChanging("msa_contact_managingpartner");
				this.SetRelatedEntity<YourNamespace.Account>("msa_contact_managingpartner", null, value);
